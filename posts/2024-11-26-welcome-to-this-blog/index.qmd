...
6. gather data;
6. determine the $p$-value and compare it with the significance level
7. only if you reject the null hypothesis accept the alternative, your working, hypothesis and claim: "male humans are (on average) heavier than female humans ($p \le 5%$ one-sided $t$-test)".
